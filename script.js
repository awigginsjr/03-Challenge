...
const collectEmployees = function () {
  ...
  while (keepGoing) {
    ...
    // Series of prompts asking for first name, last name, and salary
    const firstName = prompt("Enter first name:");
    const lastName = prompt("Enter last name:");
    let salary = prompt("Enter salary");

    // Created a condition where you set the salary to zero if it's not a number
    if (isNaN(salary)) {
      salary = 0
    }
    const employee = {
    ...
    //Ask use Do you want to add another employee
